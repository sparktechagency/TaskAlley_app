...
const Bids_QuestionCard = ({ type, from = "Tasks Details" }: { type: "bids" | "question", from?: "Tasks Details" | "My Tasks Details" }) => {
  return <View
    style={{
      padding: 10,
  ...
  >
    ...
    />
    {
      from == "My Tasks Details" && type == "bids" && <FlexText
        key={9}
        style={{
    ...
    />
    {
      from == "My Tasks Details" && type == "question" && <IconButtonTransparent
        style={{
          marginTop: 10,
          width: 140
        }}
